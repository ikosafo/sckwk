...
/* function IndustryCard(props) {
  ...
  return (
    <Card className={classes.card} raised={true} onClick={props.onClick} elevation={0} {...rest}>
      <CardMedia
...
function IndustryCard(props) {
  ...
  return (
    <Card 
    className={classes.card} raised={true} onClick={props.onClick} elevation={0} {...rest}>
...
export default withStyles(styles, { withTheme: true })(IndustryCard);
